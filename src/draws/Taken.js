...
function SvgTaken(props) {
    return (
        <svg
            ...
            {...props}
        >
            <title id="takenImgTitle">
                Fantasminha sendo abduzido por um OVNI.
            </title>
            <defs>
                <linearGradient
                    id="taken_svg__a"
